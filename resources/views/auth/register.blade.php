...
<html lang="en">
    <head>
        ...
        <link rel ="stylesheet" herf="{{ asset('assets/login,css')}}">
    />
    </head>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body p-md-5 mx-md-4">
                            ...
                            <form action="{{route('register')}}" method="post">
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <label class="form-label" for="form2Example22">Confirmar contraseña Contraseña</label>
                        ...
                        <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                            <h4 class="mb-4">Tarea Generado</h4>
